...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Health Record</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getKey <em>Key</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getLife_expectancy <em>Life expectancy</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getSmoking_prevalence <em>Smoking prevalence</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getDiabetes_prevalence <em>Diabetes prevalence</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getInfant_mortality_rate <em>Infant mortality rate</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getAdult_male_mortality_rate <em>Adult male mortality rate</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getAdult_female_mortality_rate <em>Adult female mortality rate</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getPollution_mortality_rate <em>Pollution mortality rate</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getComorbidity_mortality_rate <em>Comorbidity mortality rate</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getHospital_beds <em>Hospital beds</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getNurses <em>Nurses</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getPhysicians <em>Physicians</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getHealth_expenditure <em>Health expenditure</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getOut_of_pocket_health_expenditure <em>Out of pocket health expenditure</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.HealthRecordImpl#getIndexData <em>Index Data</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HealthRecordImpl extends MinimalEObjectImpl.Container implements HealthRecord {
	/**
	...
	protected EClass eStaticClass() {
		return covidPackage.Literals.HEALTH_RECORD;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__KEY, oldKey, key));
	}
	...
	public void setLife_expectancy(float newLife_expectancy) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__LIFE_EXPECTANCY,
	...
	public void setSmoking_prevalence(float newSmoking_prevalence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__SMOKING_PREVALENCE,
	...
	public void setDiabetes_prevalence(float newDiabetes_prevalence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__DIABETES_PREVALENCE,
	...
	public void setInfant_mortality_rate(float newInfant_mortality_rate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__INFANT_MORTALITY_RATE,
	...
	public void setAdult_male_mortality_rate(float newAdult_male_mortality_rate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__ADULT_MALE_MORTALITY_RATE,
	...
	public void setAdult_female_mortality_rate(float newAdult_female_mortality_rate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					covidPackage.HEALTH_RECORD__ADULT_FEMALE_MORTALITY_RATE, oldAdult_female_mortality_rate,
	...
	public void setPollution_mortality_rate(float newPollution_mortality_rate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__POLLUTION_MORTALITY_RATE,
	...
	public void setComorbidity_mortality_rate(float newComorbidity_mortality_rate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					covidPackage.HEALTH_RECORD__COMORBIDITY_MORTALITY_RATE, oldComorbidity_mortality_rate,
	...
	public void setHospital_beds(float newHospital_beds) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__HOSPITAL_BEDS,
	...
	public void setNurses(float newNurses) {
		...
		nurses = newNurses;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__NURSES, oldNurses,
					nurses));
	}
	...
	public void setPhysicians(float newPhysicians) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__PHYSICIANS, oldPhysicians,
					physicians));
	}
	...
	public void setHealth_expenditure(float newHealth_expenditure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__HEALTH_EXPENDITURE,
	...
	public void setOut_of_pocket_health_expenditure(float newOut_of_pocket_health_expenditure) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					covidPackage.HEALTH_RECORD__OUT_OF_POCKET_HEALTH_EXPENDITURE, oldOut_of_pocket_health_expenditure,
	...
	public IndexData getIndexData() {
		if (indexData != null && indexData.eIsProxy()) {
			...
			if (indexData != oldIndexData) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, covidPackage.HEALTH_RECORD__INDEX_DATA,
	...
	public void setIndexData(IndexData newIndexData) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.HEALTH_RECORD__INDEX_DATA, oldIndexData,
					indexData));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case covidPackage.HEALTH_RECORD__KEY:
			return getKey();
		case covidPackage.HEALTH_RECORD__LIFE_EXPECTANCY:
			return getLife_expectancy();
		case covidPackage.HEALTH_RECORD__SMOKING_PREVALENCE:
			return getSmoking_prevalence();
		case covidPackage.HEALTH_RECORD__DIABETES_PREVALENCE:
			return getDiabetes_prevalence();
		case covidPackage.HEALTH_RECORD__INFANT_MORTALITY_RATE:
			return getInfant_mortality_rate();
		case covidPackage.HEALTH_RECORD__ADULT_MALE_MORTALITY_RATE:
			return getAdult_male_mortality_rate();
		case covidPackage.HEALTH_RECORD__ADULT_FEMALE_MORTALITY_RATE:
			return getAdult_female_mortality_rate();
		case covidPackage.HEALTH_RECORD__POLLUTION_MORTALITY_RATE:
			return getPollution_mortality_rate();
		case covidPackage.HEALTH_RECORD__COMORBIDITY_MORTALITY_RATE:
			return getComorbidity_mortality_rate();
		case covidPackage.HEALTH_RECORD__HOSPITAL_BEDS:
			return getHospital_beds();
		case covidPackage.HEALTH_RECORD__NURSES:
			return getNurses();
		case covidPackage.HEALTH_RECORD__PHYSICIANS:
			return getPhysicians();
		case covidPackage.HEALTH_RECORD__HEALTH_EXPENDITURE:
			return getHealth_expenditure();
		case covidPackage.HEALTH_RECORD__OUT_OF_POCKET_HEALTH_EXPENDITURE:
			return getOut_of_pocket_health_expenditure();
		case covidPackage.HEALTH_RECORD__INDEX_DATA:
			if (resolve)
				return getIndexData();
