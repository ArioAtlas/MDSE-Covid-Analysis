 ...
 * </p>
 * <ul>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getKey <em>Key</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getWikidata <em>Wikidata</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getDatacommons <em>Datacommons</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getCountry_code <em>Country code</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getCountry_name <em>Country name</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getSubregion1_code <em>Subregion1 code</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getSubregion1_name <em>Subregion1 name</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getSubregion2_code <em>Subregion2 code</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getSubregion2_name <em>Subregion2 name</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getAlpha_2 <em>Alpha 2</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getAlpha_3 <em>Alpha 3</em>}</li>
 *   <li>{@link mdse.covd.covidCsv.impl.IndexDataImpl#getAggregation_level <em>Aggregation level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexDataImpl extends MinimalEObjectImpl.Container implements IndexData {
	...
	protected EClass eStaticClass() {
		return covidPackage.Literals.INDEX_DATA;
	}
	...
	public void setKey(String newKey) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__KEY, oldKey, key));
	}
	...
	public void setWikidata(String newWikidata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__WIKIDATA, oldWikidata,
					wikidata));
	}
	...
	public void setDatacommons(String newDatacommons) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__DATACOMMONS, oldDatacommons,
					datacommons));
	}
	...
	public void setCountry_code(String newCountry_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__COUNTRY_CODE,
					oldCountry_code, country_code));
	}
	...
	public void setCountry_name(String newCountry_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__COUNTRY_NAME,
					oldCountry_name, country_name));
	}
	...
	public void setSubregion1_code(String newSubregion1_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__SUBREGION1_CODE,
	...
	public void setSubregion1_name(String newSubregion1_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__SUBREGION1_NAME,
	...
	public void setSubregion2_code(String newSubregion2_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__SUBREGION2_CODE,
	...
	public void setSubregion2_name(String newSubregion2_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__SUBREGION2_NAME,
	...
	public void setAlpha_2(String newAlpha_2) {
		...
		alpha_2 = newAlpha_2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__ALPHA_2, oldAlpha_2,
					alpha_2));
	}
	...
	public void setAlpha_3(String newAlpha_3) {
		...
		alpha_3 = newAlpha_3;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__ALPHA_3, oldAlpha_3,
					alpha_3));
	}
	...
	public void setAggregation_level(int newAggregation_level) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, covidPackage.INDEX_DATA__AGGREGATION_LEVEL,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case covidPackage.INDEX_DATA__KEY:
			return getKey();
		case covidPackage.INDEX_DATA__WIKIDATA:
			return getWikidata();
		case covidPackage.INDEX_DATA__DATACOMMONS:
			return getDatacommons();
		case covidPackage.INDEX_DATA__COUNTRY_CODE:
			return getCountry_code();
		case covidPackage.INDEX_DATA__COUNTRY_NAME:
			return getCountry_name();
		case covidPackage.INDEX_DATA__SUBREGION1_CODE:
			return getSubregion1_code();
		case covidPackage.INDEX_DATA__SUBREGION1_NAME:
			return getSubregion1_name();
		case covidPackage.INDEX_DATA__SUBREGION2_CODE:
			return getSubregion2_code();
		case covidPackage.INDEX_DATA__SUBREGION2_NAME:
			return getSubregion2_name();
		case covidPackage.INDEX_DATA__ALPHA_2:
			return getAlpha_2();
		case covidPackage.INDEX_DATA__ALPHA_3:
			return getAlpha_3();
		case covidPackage.INDEX_DATA__AGGREGATION_LEVEL:
