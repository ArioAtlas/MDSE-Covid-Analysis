 ...
 * </p>
 * <ul>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getWikidata <em>Wikidata</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getDatacommons <em>Datacommons</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getCountry_code <em>Country code</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getCountry_name <em>Country name</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getSubregion1_code <em>Subregion1 code</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getSubregion1_name <em>Subregion1 name</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getSubregion2_code <em>Subregion2 code</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getSubregion2_name <em>Subregion2 name</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getLocality_code <em>Locality code</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getLocality_name <em>Locality name</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getAlpha_2 <em>Alpha 2</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getAlpha_3 <em>Alpha 3</em>}</li>
 *   <li>{@link se.lnu.joa.covid.model.data.impl.IndexImpl#getAggregation_level <em>Aggregation level</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IndexImpl extends DataRecordImpl implements Index {
	...
	public void setWikidata(String newWikidata) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__WIKIDATA, oldWikidata, wikidata));
	}
	...
	public void setDatacommons(String newDatacommons) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__DATACOMMONS, oldDatacommons, datacommons));
	}
	...
	public void setCountry_code(String newCountry_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__COUNTRY_CODE, oldCountry_code, country_code));
	}
	...
	public void setCountry_name(String newCountry_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__COUNTRY_NAME, oldCountry_name, country_name));
	}
	...
	public void setSubregion1_code(String newSubregion1_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__SUBREGION1_CODE, oldSubregion1_code, subregion1_code));
	}
	...
	public void setSubregion1_name(String newSubregion1_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__SUBREGION1_NAME, oldSubregion1_name, subregion1_name));
	}
	...
	public void setSubregion2_code(String newSubregion2_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__SUBREGION2_CODE, oldSubregion2_code, subregion2_code));
	}
	...
	public void setSubregion2_name(String newSubregion2_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__SUBREGION2_NAME, oldSubregion2_name, subregion2_name));
	}
	...
	public void setLocality_code(String newLocality_code) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__LOCALITY_CODE, oldLocality_code, locality_code));
	}
	...
	public void setLocality_name(String newLocality_name) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__LOCALITY_NAME, oldLocality_name, locality_name));
	}
	...
	public void setAlpha_2(String newAlpha_2) {
		...
		alpha_2 = newAlpha_2;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__ALPHA_2, oldAlpha_2, alpha_2));
	}
	...
	public void setAlpha_3(String newAlpha_3) {
		...
		alpha_3 = newAlpha_3;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DataPackage.INDEX__ALPHA_3, oldAlpha_3, alpha_3));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DataPackage.INDEX__WIKIDATA:
				return getWikidata();
			case DataPackage.INDEX__DATACOMMONS:
				return getDatacommons();
			case DataPackage.INDEX__COUNTRY_CODE:
				return getCountry_code();
			case DataPackage.INDEX__COUNTRY_NAME:
				return getCountry_name();
			case DataPackage.INDEX__SUBREGION1_CODE:
				return getSubregion1_code();
			case DataPackage.INDEX__SUBREGION1_NAME:
				return getSubregion1_name();
			case DataPackage.INDEX__SUBREGION2_CODE:
				return getSubregion2_code();
			case DataPackage.INDEX__SUBREGION2_NAME:
				return getSubregion2_name();
			case DataPackage.INDEX__LOCALITY_CODE:
				return getLocality_code();
			case DataPackage.INDEX__LOCALITY_NAME:
				return getLocality_name();
			case DataPackage.INDEX__ALPHA_2:
				return getAlpha_2();
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case DataPackage.INDEX__LOCALITY_CODE:
				return LOCALITY_CODE_EDEFAULT == null ? locality_code != null : !LOCALITY_CODE_EDEFAULT.equals(locality_code);
			case DataPackage.INDEX__LOCALITY_NAME:
				return LOCALITY_NAME_EDEFAULT == null ? locality_name != null : !LOCALITY_NAME_EDEFAULT.equals(locality_name);
			case DataPackage.INDEX__ALPHA_2:
