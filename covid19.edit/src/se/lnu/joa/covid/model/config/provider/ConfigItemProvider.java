...
/**
 * This is the item provider adapter for a {@link se.lnu.joa.covid.model.config.Config} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigPackage.Literals.CONFIG__SOURCE,
				 ConfigFactory.eINSTANCE.createDataModel()));
		...
		newChildDescriptors.add
			(createChildParameter
				(ConfigPackage.Literals.CONFIG__REGRESSION,
				 ConfigFactory.eINSTANCE.createRegression()));

		newChildDescriptors.add
			(createChildParameter
				(ConfigPackage.Literals.CONFIG__ANIMATION,
				 ConfigFactory.eINSTANCE.createAnimation()));
	}
