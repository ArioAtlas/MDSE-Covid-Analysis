...
/**
 * This is the item provider adapter for a {@link se.lnu.joa.covid.model.config.DataModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataModel_datasetName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataModel_datasetName_feature", "_UI_DataModel_type"),
				 ConfigPackage.Literals.DATA_MODEL__DATASET_NAME,
				 true,
				 false,
				 false,
	...
	protected void addDataSourcePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataModel_dataSource_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataModel_dataSource_feature", "_UI_DataModel_type"),
				 ConfigPackage.Literals.DATA_MODEL__DATA_SOURCE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((DataModel)object).getDatasetName();
