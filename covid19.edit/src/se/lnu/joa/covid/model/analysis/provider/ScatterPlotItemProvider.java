...
/**
 * This is the item provider adapter for a {@link se.lnu.joa.covid.model.analysis.ScatterPlot} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScatterPlotItemProvider extends VisualizationItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScatterPlot_alpha_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScatterPlot_alpha_feature", "_UI_ScatterPlot_type"),
				 AnalysisPackage.Literals.SCATTER_PLOT__ALPHA,
				 true,
				 false,
				 false,
	...
	protected void addStrokePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ScatterPlot_stroke_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ScatterPlot_stroke_feature", "_UI_ScatterPlot_type"),
				 AnalysisPackage.Literals.SCATTER_PLOT__STROKE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(AnalysisPackage.Literals.SCATTER_PLOT__ANIMATION);
		}
	...
	public String getText(Object object) {
		String label = ((ScatterPlot)object).getXAxis();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ScatterPlot.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(AnalysisPackage.Literals.SCATTER_PLOT__ANIMATION,
