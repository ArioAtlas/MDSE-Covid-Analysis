...
public class HealthItemProvider extends DataRecordItemProvider {
	...
	protected void addDiabetes_prevalencePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_diabetes_prevalence_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_diabetes_prevalence_feature",
								"_UI_Health_type"),
						Covid19Package.Literals.HEALTH__DIABETES_PREVALENCE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addInfant_mortality_ratePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_infant_mortality_rate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_infant_mortality_rate_feature",
								"_UI_Health_type"),
						Covid19Package.Literals.HEALTH__INFANT_MORTALITY_RATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdult_male_mortality_ratePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_adult_male_mortality_rate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_adult_male_mortality_rate_feature",
								"_UI_Health_type"),
						Covid19Package.Literals.HEALTH__ADULT_MALE_MORTALITY_RATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addAdult_female_mortality_ratePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_Health_adult_female_mortality_rate_feature",
						"_UI_Health_type"),
				Covid19Package.Literals.HEALTH__ADULT_FEMALE_MORTALITY_RATE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPollution_mortality_ratePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_pollution_mortality_rate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_pollution_mortality_rate_feature",
								"_UI_Health_type"),
						Covid19Package.Literals.HEALTH__POLLUTION_MORTALITY_RATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addComorbidity_mortality_ratePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_comorbidity_mortality_rate_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_comorbidity_mortality_rate_feature",
								"_UI_Health_type"),
						Covid19Package.Literals.HEALTH__COMORBIDITY_MORTALITY_RATE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addHospital_bedsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_hospital_beds_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_hospital_beds_feature",
								"_UI_Health_type"),
						Covid19Package.Literals.HEALTH__HOSPITAL_BEDS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addNursesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_nurses_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_nurses_feature", "_UI_Health_type"),
						Covid19Package.Literals.HEALTH__NURSES, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addPhysiciansPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_physicians_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_physicians_feature",
								"_UI_Health_type"),
						Covid19Package.Literals.HEALTH__PHYSICIANS, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addHealth_expenditurePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Health_health_expenditure_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Health_health_expenditure_feature",
								"_UI_Health_type"),
						Covid19Package.Literals.HEALTH__HEALTH_EXPENDITURE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addOut_of_pocket_health_expenditurePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				...
				getString("_UI_PropertyDescriptor_description", "_UI_Health_out_of_pocket_health_expenditure_feature",
						"_UI_Health_type"),
				Covid19Package.Literals.HEALTH__OUT_OF_POCKET_HEALTH_EXPENDITURE, true, false, false,
				ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
